...
def prepare_build_matrix(factory, configfile, as_axis):
    ...
    result = _create_return_value(configs, as_axis)
...
def _create_return_value(configs, as_axis):
    if as_axis:
        return get_options_string(configs)
